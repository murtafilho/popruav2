...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("SELECT AddGeometryColumn('public', 'geo_regionais', 'geom', 4326, 'MULTIPOLYGON', 2)");
        DB::statement('CREATE INDEX idx_geo_regionais_geom ON geo_regionais USING GIST(geom)');
    }
